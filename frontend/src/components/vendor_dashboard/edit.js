...
class EditVendor extends React.Component {
  ...
  componentDidMount() {
    let load = { vendor_id: localStorage.getItem("token") };
    axios.post("http://localhost:4000/api/vendor/details", load).then((res) => {
      this.setState({
  ...
  render() {
    ...
    let handleUpdate = () => {
      ...
      axios
        .post("http://localhost:4000/api/vendor/update", load)
        .then((res, err) => {
              ...
              >
                <Grid item>
                  <TextField
                    ...
                    label="Shop Name"
                    value={this.state.BuyerDetails.shopName}
                    variant="outlined"
                  ></TextField>
                </Grid>
                <Grid item>
                  <IconButton
                    aria-label="edit"
                    onClick={() =>
                      handleOpen("Enter new Name of Shop!!", "shopName")
                    }
                  >
                    <EditIcon />
                  </IconButton>
              ...
              >
                <Grid item>
                  <TextField
                    ...
                    label="Manager Name"
                    value={this.state.BuyerDetails.managerName}
                    variant="outlined"
                  ></TextField>
                </Grid>
                <Grid item>
                  <IconButton
                    aria-label="edit"
                    onClick={() =>
                      handleOpen("Enter new Name of manager!!", "managerName")
                    }
                  >
                    <EditIcon />
                  </IconButton>
